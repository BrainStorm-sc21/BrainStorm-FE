      ...
      body: AddFoodLayout(
        ...
        body: Column(
          children: [
            ...
            FoodStorage(storage: food.storage, setStorage: setStorage), // 식료품 보관장소 선택
            divider,
            FoodStock(
                stock: food.stock,
                setStock: setStock,
            ...
            divider,
            FoodExpireDate(
                expireDate: food.expireDate, setExpireDate: setExpireDate), // 식료품 소비기한 입력
          ],
        ),
          ...
          children: List<Widget>.generate(3, (index) {
            return RoundedOutlinedButton(
              ...
              backgroundColor: storage == _storages[index]
                  ...
                  : Colors.white,
              foregroundColor: storage == _storages[index] ? Colors.white : Colors.black,
